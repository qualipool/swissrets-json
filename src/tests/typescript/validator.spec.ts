...
describe('Unit Test: Validate Samples', () => {
  it('Valid - Should not return error', () => {
    const output = performSwissRetsObjectSchemaValidation(provideTestData('sr-valid'));
  ...
  it('Invalid - missing referenceId', () => {
    ...
    const output = performSwissRetsObjectSchemaValidation(testData);
  ...
  it('Invalid - project.unit has same refenereceId', () => {
    const output = performSwissRetsObjectSchemaValidation(provideTestData('sr-invalid-uniqId'));
  ...
  it('Invalid - properties.unitReferenceId is not same as project.unit.refenereceId', () => {
    const output = performSwissRetsObjectSchemaValidation(provideTestData('sr-invalid-sameAs'));

...
describe('projects[0].localizations[0].attachments.documents[0] tests', () => {
  it('Invalid - projects[0].localizations[0].attachments.documents[0] must be object', () => {
  ...
  it('Invalid - projects[0].localizations[0].attachments.documents[0] cannot have additional properties', () => {
  ...
  it('Invalid - projects[0].localizations[0].attachments.documents[0].url must be string', () => {
    const clone = stubSrFullModified(
  ...
  it('Invalid - projects[0].localizations[0].attachments.documents[0].title must be string', () => {
    const clone = stubSrFullModified(
  ...
  it('Invalid - projects[0].localizations[0].attachments.documents[0].mimeType must be string', () => {
    const clone = stubSrFullModified(

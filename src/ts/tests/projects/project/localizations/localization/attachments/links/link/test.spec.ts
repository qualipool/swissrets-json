...
describe('projects[0].localizations[0].attachments.links[0] tests', () => {
  ...
  it('Invalid - projects[0].localizations[0].attachments.links[0] cannot have additional properties', () => {
  ...
  it('Invalid - projects[0].localizations[0].attachments.links[0].url must be string', () => {
  ...
  it('Invalid - projects[0].localizations[0].attachments.links[0].title must be string', () => {
    const clone = stubSrFullModified(
